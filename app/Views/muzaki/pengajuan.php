...
<div class="row" ng-controller="pembayaranController">
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-body">
                <form ng-submit="save()">
                    ...
                    <div class="form-group row mb-2 align-items-center">
                        ...
                        <div class="col-sm-4">
                            <select id="jenis_bantuan" class="form-control form-control-sm" ng-options="item as item.nama_kategori for item in datas.kategori" ng-model="kategori" ng-change="model.id_kategori=kategori.id; model.id_muzaki = datas.biodata.id; model.id_mustahik=null" required>
